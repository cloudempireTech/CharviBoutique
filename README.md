...
The three photographs in `assets/images` show Charvi Boutique displays. They were retrieved from the [Charvi Boutique photo listing on Magicpin](https://magicpin.in/Kolkata/Ballygunge-Phari/Fashion/Charvi-Boutique/store/1cc20a/photos?img=Store-Images) and converted to responsive WebP versions while retaining JPEG fallbacks. They represent past displays; the website does not claim they show current stock. There were no files attached to the brief.
